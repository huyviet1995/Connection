 ...
 */
public class AsyncResetPassword extends AsyncTask<String, String, String> {
    ...
    public AsyncResetPassword(Activity activity) {
        mActivity = activity;
    }
    @Override
    protected String doInBackground(String... params) {
        ...
        try {
            url = new URL("http://vietdanghuy.net23.net/android_connect/resetPassword.php");
